...
- TVmaze's provider rating is stored as a `/10` value. Order cards alone render it as a five-star Straw SVG overlay, rounded to the nearest half-star; Add and Board cards do not render ratings.
